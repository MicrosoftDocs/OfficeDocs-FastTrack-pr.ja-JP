...
|ファイル共有、ボックス  <br/> | 定義済の移行バッチに基づく 24 時間 x 5 日。  <br/>  移行日あたり 3 つの移行バッチ。  <br/>  月曜日の午前 2 時 (UTC) から 金曜日の深夜 0 時 (UTC) まで、1 週間に 5 日間の移行日があります。  <br/>  最後にスケジュールされる移行間隔は、金曜日の午後 8 時 (UTC) です。  <br/> |
