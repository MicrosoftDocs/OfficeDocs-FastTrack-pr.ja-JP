...
\*2017 年 9 月 1 日までに商用プランを購入または更新した場合、移行特典を受けるためのシート数の最小要件は、現在のサブスクリプション期間中に 150 シートとなります。教育機関向けのプランでは、教員および職員のみ移行サービスの対象となります。 
...
Microsoft によってメールを移行する場合、弊社は移行のために Exchange Online と移行元の環境の両方を有効にするためのガイダンスを提供します。移行元の環境に応じて、さまざまな有効化手順を実行することがあります。 ツール、ドキュメントを組み合わせて使ったり、可能な場合には構成タスクを実行したりするなどしてガイダンスを提供します。適用可能なパラメーターがある場合には、それに応じてメールボックスを移行し、ジョブを監視し、進捗レポートを提供します。
  
移行アクティビティを実行するには、メール システムに対するアクセスとアクセス許可が必要となる場合があります。
  
 **移行ポリシーと手順**
  
- 定義済みの移行時間帯に、標準化されて事前にスケジュールされた 1 日 24 時間、週 5 営業日 (24 x 5) 体制で移行が行われます。 「移行時間帯」は「移行バッチ」とも呼ばれます。    
- 移行日あたり 3 つの移行バッチがあります。協定世界時 (UTC) で月曜日の午前 2 時から金曜日深夜 0 時 (UTC) までの平日には、移行日が 5 日あります。つまり、最後のスケジュールされた移行は金曜日の午後 8 時 (UTC) となります。
- すべての移行は、クラウド ベースの移行ツールを使用します。
- 移行アクティビティを実行するには、メール システムに対するアクセスとアクセス許可が必要となる場合があります。
...
|**Exchange 2003 以降**|一括| メール <br/> メールボックスのルール <br/> デリゲート <br/> メールボックスの連絡先 <br/> 予定表 <br/> タスク | パブリック フォルダー <br/> 個人用連絡先 <br/> メールが有効なユーザー <br/> ブロックされたユーザーまたは非アクティブなユーザー <br/> 署名 <br/> メールボックス収集 <br/>  メッセージのサイズ制限を超えている電子メール <br/> アーカイブ データ <br/> 権限が管理された、または暗号化された電子メール <br/> 破損アイテム <br/>  非アクティブなメールボックス |
|**Exchange 2003 および Exchange 2007**|段階的| 電子メール <br/> メールボックスのルール <br/> デリゲート <br/> メールボックスの連絡先 <br/> 予定表 <br/> タスク | パブリック フォルダー <br/> 個人用連絡先 <br/> メールが有効なユーザー <br/> ブロックされたユーザーまたは非アクティブなユーザー <br/> 署名 <br/> メールボックス収集 <br/> メッセージのサイズ制限を超えている電子メール <br/> アーカイブ データ <br/> 権限が管理された、または暗号化された電子メール <br/> 破損アイテム <br/> 非アクティブなメールボックス |
|**Exchange 2010、Exchange 2013、Exchange 2016** <br/><br/> **メモ** *オンプレミスの Exchange の依存関係については、「[ハイブリッド展開の前提条件](https://go.microsoft.com/fwlink/?LinkId=787528)」を参照してください。*           |ハイブリッド展開での移行| 電子メール <br/> メールボックスのルール <br/> デリゲート <br/> メールボックスの連絡先 <br/> 予定表 <br/> タスク <br/> 署名 <br/> ユーザーのメールボックスと一緒に移行された個人用アーカイブ <br/> 回復可能なアイテム | パブリック フォルダー <br/> メッセージのサイズ制限を超えている電子メール <br/> ジャーナリング アーカイブやサード パーティ製アーカイブ ソリューション <br/> ブロックされたユーザーまたは非アクティブなユーザー <br/> パーソナル ストレージ テーブル (PST) ファイルのアーカイブ データ <br/> 権限が管理されたメールや暗号化されたメール <br/> 破損アイテム <br/> 非アクティブなメールボックス |
|**G Suite 環境 (Gmail、連絡先、カレンダーのみ)** <br/> <br/> **メモ** *データの場所: FastTrack は、米国内外で Microsoft やサード パーティのサプライヤーが施設を保有する顧客のテナントの場所に基づいて、データの転送、保管、処理を行う場合があります。FastTrack は、該当するサービスの完了から 30 日以内に保存したデータを削除します。*           |カット オーバーまたは段階的| メール <br/> メールボックスの連絡先 <br/> 予定表 <br/> ラベル | ルール <br/> デリゲート <br/> 署名 <br/> タスク <br/> 35 MB を超える電子メールまたは添付ファイル <br/> ブロックされたユーザーまたは非アクティブなユーザー <br/> PST ファイルまたはサード パーティのアーカイブ ソリューション (たとえば、Google Vault) のアーカイブ データ <br/> 権限が管理された、または暗号化された電子メール <br/> 破損アイテム <br/> Google ハングアウト <br/> Google グループ <br/> リソース メールボックス <br/> 非アクティブなメールボックス |
|**IBM Domino 7.0.3 以降** ([付録 A: IBM Domino から Exchange Online への移行](from-ibm-domino-to-exchange-online.md))|段階的| 電子メール - 過去 90 日間 <br/> 予定表 - 過去 90 日間と今後のアイテム <br/> メールボックスの連絡先 - すべて <br/> タスク - すべて <br/> 会議室とリソース - 標準テンプレートと共に実装されていることが条件 <br/> 共有メール ファイルを含むメール ファイルは、標準メール テンプレートを使用する必要があります | 署名 <br/> メールボックスのルール <br/> デリゲート <br/> 暗号化されたアイテム <br/> ドキュメントのリンク <br/> ユーザーのひな形 <br/> メッセージのサイズ制限を超えている電子メール <br/> ブロックされたユーザーまたは非アクティブなユーザー <br/> アーカイブ データ <br/> 破損アイテム <br/> 予定表の共存 <br/> 非アクティブなメールボックス |
|**Novell GroupWise 7.0.4 以降** <br/><br/> **メモ** *データの場所: FastTrack は、米国内外で Microsoft やサード パーティのサプライヤーが施設を保有する顧客のテナントの場所に基づいて、データの転送、保管、処理を行う場合があります。FastTrack は、該当するサービスの完了から 30 日以内に保存したデータを削除します。*           |段階的| メール <br/> 予定表 <br/> メールボックスの連絡先 <br/> 個人用グループ <br/> タスク (制限があります) <br/> ドキュメント | ルール <br/> プロキシ/デリゲート/アクセス制御リスト (ACL) の変換 <br/> 署名 <br/> 連絡先のカテゴリ <br/> 暗号化された電子メール <br/> 検索フォルダー <br/> 35 MB を超える電子メールまたは添付ファイル <br/> ブロックされたユーザーまたは非アクティブなユーザー <br/> アーカイブ データ <br/> 権限が管理された、または暗号化されたアイテム <br/> 破損アイテム <br/> 予定表の共存 <br/> 非アクティブなメールボックス |
...
> [!NOTE]
> 配布リスト (MailEnabledGroup オブジェクト) と外部連絡先 (MailEnabledContact オブジェクト) がオンプレミスの Active Directory 内にある場合、Azure AD Connect を使用して同期することができます。ただし、これらはメールボックス データ移行の一部ではありません。詳細については、**コア**の「 [ID の統合](onboarding-and-migration.md#core) 」の例を参照してください。 
...
- Office 365 のガイドラインどおりに、適切なレベルのクライアント ソフトウェアをインストールします。詳細については、「[Office 365 for Business](https://go.microsoft.com/fwlink/?linkid=2005429)」を参照してください。 
- 該当する場合には、ソース メッセージング環境と Office 365 Exchange Online の間の SMTP メール ルーティングの共存を検証します。
- 各移行イベントの少なくとも 14 日前に、定義された方法で設定したスケジュールと、移行する特定のメールボックスの一覧を提供します。Notes の移行の場合、21 日前にはスケジュールを必ず設定する必要があります。
- 移行バッチの 3 日前までに、既にスケジュールされているメールボックスの最大 10% までの範囲で、新しいメールボックスや再スケジュールされたメールボックスのスケジュールを追加します。これが最終の移行バッチとなります。  
- 移行バッチの 24 時間前までに、スケジュールからメールボックスを削除します。これが最終の移行バッチとなります。
...
- 移行は、次の表に示すように、移行元に基づいて標準化されたスケジュールどおりの完了を目標とします\*。 
    
|||
|:-----|:-----|
|**移行元** <br/> |**スケジュール ポリシー** <br/> |
|**ファイル共有、Box**  <br/> | 定義済の移行バッチに基づく 24 時間 x 5 日。  <br/>  移行日あたり 3 つの移行バッチ。  <br/>  月曜日の午前 2 時 (UTC) から 金曜日の深夜 0 時 (UTC) まで、1 週間に 5 日間の移行日があります。  <br/>  最後にスケジュールされる移行間隔は、金曜日の午後 8 時 (UTC) です。  <br/> |
   
*スケジュールは、想定されたデータセットのサイズと環境の要因に基づいています。スケジュール済のコンテンツが、単一の移行間隔内に移行できないことがあります。
    
- 移行は、定義済みの移行バッチにおいて、標準化され事前にスケジュールされた平日 24 時間体制で行われます。
- 移行日あたり 3 つの移行バッチがあります。月曜日の午前 2 時 (UTC) から金曜日深夜 0 時 (UTC) までの平日には、移行日が 5 日あります。つまり、最後のスケジュールされた移行は金曜日の午後 8 時 (UTC) となります。  
- すべての移行には、ソース環境に対する適切なアクセスとアクセス許可が必要です。  
- すべての移行は、「[SharePoint Online のソフトウェアの境界と制限](https://go.microsoft.com/fwlink/?LinkID=616612)」に記載されている SharePoint Online クォータの対象になります。   
...
|:-----|:-----|
|**移行元** <br/> |**スケジュール ポリシー** <br/> |
|**ファイル共有、Box、Google ドライブ**  <br/> | 定義済の移行バッチに基づく 24 時間 x 5 日。  <br/>  移行日あたり 3 つの移行バッチ。  <br/>  月曜日の午前 2 時 (UTC) から 金曜日の深夜 0 時 (UTC) まで、1 週間に 5 日間の移行日があります。  <br/>  最後にスケジュールされる移行間隔は、金曜日の午後 8 時 (UTC) です。  <br/> |
...
|**単一の G Suite 環境 (Google ドライブのみ)**  <br/> |単一パス  <br/> | Google ドキュメント、スプレッドシート、スライド (ファイルは対応する Office 形式に変換されます)  <br/>  Google 図形描画 (ファイルは SVG や PNG 形式に変換されます)  <br/>  ファイルとフォルダーの構造  <br/>  ユーザー レベルのファイルとフォルダーのアクセス許可  <br/>  グループ レベルのファイルとフォルダーのアクセス許可  <br/>  15 GB 未満のファイル  <br/>  基本的なドキュメントとフォルダーのメタデータ:  <br/>  作成日  <br/>  更新日  <br/>  作成者  <br/>  最終更新者  <br/>  移行される Google Drive アカウントが所有する共有コンテンツ (ユーザーまたはグループと明示的に共有する場合)  <br/> | 所有権の履歴、以前のバージョン、コメント  <br/>  ファイルとフォルダーの説明、フォルダーの色  <br/>  コンテンツ内に埋め込まれた URL の変換  <br/>  ごみ箱に入れられたアイテム  <br/>  アクセスできない、または破損しているドキュメント  <br/>  ブロックされたユーザーまたは非アクティブなユーザー  <br/>  組織外との共有コンテンツ  <br/>  Google フォト、フォーム、マップとその他の接続されたアプリ  <br/>  現在の [SharePoint Online の制限事項と制約事項](https://go.microsoft.com/fwlink/?linkid=846724)から逸脱するファイルまたはフォルダー <br/> |
